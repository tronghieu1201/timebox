...
for (const required of ['style.css?v=45', 'life.css?v=45', 'space-navigation.css?v=45', 'orbital-archive.css?v=44', 'theme.js?v=44', 'life.js?v=41', 'space-navigation.bundle.js?v=42', 'images/space/earth_day.webp']) {
...
if (!serviceWorker.includes("shell-v45") ||
    !serviceWorker.includes("static-v45") ||
